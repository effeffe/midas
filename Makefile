...
CC = gcc $(USERFLAGS)
CXX = g++ $(USERFLAGS)
CFLAGS = -std=c++11 -g -O2 -Wall -Wformat=2 -Wno-format-nonliteral -Wno-strict-aliasing -Wuninitialized -I$(INC_DIR) -I$(DRV_DIR) -I$(MXML_DIR) -I$(MSCB_DIR)/include -DHAVE_FTPLIB
