...
int vxi11_open_device(const char *ip, CLIENT **client, VXI11_LINK **link, char *device) {
   ...
   *client = clnt_create((char *) ip, DEVICE_CORE, DEVICE_CORE_VERSION, (char *) "tcp");
...
/* wrapper, for default timeout */ long
vxi11_receive(CLIENT *client, VXI11_LINK *link, char *buffer, unsigned long len) {
