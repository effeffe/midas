...
\********************************************************************/
{
   ...
   if (use_posix_shm) {
      ...
      fh = open(file_name, O_RDONLY | O_BINARY | O_LARGEFILE, 0777);
...
/*------------------------------------------------------------------*/
INT ss_shm_flush(const char *name, const void *adr, size_t size, HNDLE handle)
/********************************************************************\
