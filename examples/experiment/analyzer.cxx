...
INT analyzer_init()
{
   ...
   db_create_record(hDB, 0, "/Runinfo", strcomb1((const char **)runinfo_str).c_str());
   ...
   db_create_record(hDB, 0, "/Experiment/Run Parameters", strcomb1((const char **)exp_param_str).c_str());
   ...
   db_create_record(hDB, 0, str, strcomb1((const char **)global_param_str).c_str());
   ...
   db_create_record(hDB, 0, "/Equipment/Trigger/Settings", strcomb1((const char **)trigger_settings_str).c_str());
